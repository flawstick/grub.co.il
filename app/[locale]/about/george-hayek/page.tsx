...
const navItems = [
  { id: "introduction", titleKey: "navigation.introduction" },
  { id: "background", titleKey: "navigation.background" },
  { id: "vision", titleKey: "navigation.vision" },
  { id: "expertise", titleKey: "navigation.expertise" },
  { id: "thoughts", titleKey: "navigation.thoughts" },
  { id: "contact", titleKey: "navigation.contact" },
];

export default function GeorgeHayekPage() {
  const t = useTranslations("GeorgeHayekPage");
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <SideNavigation items={localizedNavItems} />
          </div>
          <div className="md:col-span-3">
            ...
            <motion.section id="expertise" {...fadeIn}>
              ...
              <ul className="list-disc list-inside space-y-4 mb-8 text-gray-600 dark:text-gray-300">
                <li>{t("expertise.point1")}</li>
                <li>{t("expertise.point2")}</li>
                <li>{t("expertise.point3")}</li>
                <li>{t("expertise.point4")}</li>
              </ul>
              <Image
                src="/placeholder.svg?height=400&width=600"
