...
export default function ForEmployeesPage() {
  const t = useTranslations("ForEmployeesPage");
  ...
  const navItems = [
    ...
    { id: "testimonials", title: t("navigation.testimonials") },
          ...
          <div className="md:col-span-3">
            ...
            <motion.section id="testimonials" {...fadeIn}>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                {Object.keys(t.raw("testimonials.items")).map((key) => (
                  <div
                    key={key}
            ...
            <motion.section id="get-started" {...fadeIn}>
              ...
              <div className="flex justify-center space-x-4">
                ...
                >
                  <Link href="/download">{t("getStarted.downloadButton")}</Link>
                </Button>
                <Button
                  asChild
                  variant="outline"
                ...
                >
                  <Link href="/contact">{t("getStarted.learnMoreButton")}</Link>
                </Button>
              </div>
            </motion.section>
          </div>
