...
export default function CustomizableMenusPage() {
  const t = useTranslations("CustomizableMenusPage");
  ...
  const navItems = [
    ...
    },
    {
      ...
      subItems: [
        { id: "menu-creation", title: t("nav.menuCreation") },
        { id: "dietary-options", title: t("nav.dietaryOptions") },
        { id: "seasonal-rotations", title: t("nav.seasonalRotations") },
      ],
    },
    {
      id: "how-it-works",
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-3">
            ...
            <motion.section id="key-features" {...fadeIn}>
              ...
              {["menuCreation", "dietaryOptions", "seasonalRotations"].map(
                (feature) => (
